...
>The effective number of parameters will decrease because a concentrated prior in practice will reduce the influence of the less informative parameters in the model. The penalty term will be lower in the more concentrated prior. This constrains the coefficients to be close to zero or whatever value you set them to.
